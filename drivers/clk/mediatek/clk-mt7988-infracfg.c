...
static const struct mtk_gate infra_clks[] = {
	...
	GATE_INFRA3(CLK_INFRA_USB_FRMCNT, "infra_usb_frmcnt", "usb_frmcnt_sel",
		    8),
	GATE_INFRA3(CLK_INFRA_USB_FRMCNT_CK_P1, "infra_usb_frmcnt_ck_p1",
		    "usb_frmcnt_p1_sel", 9),
	GATE_INFRA3(CLK_INFRA_USB_PIPE, "infra_usb_pipe", "top_xtal", 10),
